<%@ Page language="c#" Codebehind="EdView.aspx.cs" AutoEventWireup="false" Inherits="CMSNET.Administration.Edit.EdView" %>
...
<HTML>
    ...
    <body>
        <form id="EdView" method="post" runat="server">
            <H2>
            ...
            &nbsp;
            <asp:button id="bnEdit" runat="server" Text="Edit"></asp:button>
        </form>
    </body>
</HTML>
